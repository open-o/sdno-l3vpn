...
/**
 * The health check rest interface of l3vpn.<br/>
 * 
 * @author
 * @version SDNO 0.5 Feb 14, 2017
 */
@Service
@Path("/sdnol3vpn/v1/healthcheck")
public class L3VpnHealthCheckResource extends IResource {

    @Override
    public String getResUri() {
        return "/sdnol3vpn/v1/healthcheck";
    }
