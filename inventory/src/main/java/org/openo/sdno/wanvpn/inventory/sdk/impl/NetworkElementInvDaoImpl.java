 ...
 */
public class NetworkElementInvDaoImpl implements BaseInvDao<NetworkElementMO> {

    private static final Logger LOGGER = LoggerFactory.getLogger(NetworkElementInvDaoImpl.class);
