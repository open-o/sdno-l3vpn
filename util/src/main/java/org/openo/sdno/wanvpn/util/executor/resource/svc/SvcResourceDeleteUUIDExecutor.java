 ...
 */
public abstract class SvcResourceDeleteUUIDExecutor<R> {
     ...
     */
    public SvcResourceDeleteUUIDExecutor(String uuid) throws ServiceException {
        this.uuid = uuid;
    }
    ...
    public ExecutorResultContainer<R> execute() throws ServiceException {
        ...
        return new ExecutorResultContainer<>(implementDelete(uuid));
    }

    protected abstract R implementDelete(String uuid) throws ServiceException;
