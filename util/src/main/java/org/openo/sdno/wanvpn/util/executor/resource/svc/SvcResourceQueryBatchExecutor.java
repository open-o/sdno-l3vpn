 ...
 */
public abstract class SvcResourceQueryBatchExecutor<R> {
     ...
     */
    public SvcResourceQueryBatchExecutor(@Context HttpServletRequest request) throws ServiceException {
    ...
    private void assertParams(BatchQueryParams batchQueryParams) throws ServiceException {
    ...
    public ExecutorResultContainer<BatchQueryResult<R>> execute() throws ServiceException {
        ...
        return new ExecutorResultContainer<>(implementQuery(batchQueryParams));
    }
