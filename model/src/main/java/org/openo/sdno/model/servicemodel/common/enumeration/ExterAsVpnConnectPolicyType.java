 ...
 */
public enum ExterAsVpnConnectPolicyType implements ModelEnum {
    OPTION_A("OptionA"), OPTION_B("OptionB"), OPTION_C("OptionC"), NOP("nop");

    private String alias;

    private ExterAsVpnConnectPolicyType(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static ExterAsVpnConnectPolicyType fromName(String name) {
        return EnumUtil.valueOf(ExterAsVpnConnectPolicyType.class, name);
    }
