 ...
 */
public enum ManageProtocolType implements ModelEnum {
    NETCONF("netconf"), PCEP("pcep");

    private String alias;

    private ManageProtocolType(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static ManageProtocolType fromName(String name) {
        return EnumUtil.valueOf(ManageProtocolType.class, name);
    }
}
