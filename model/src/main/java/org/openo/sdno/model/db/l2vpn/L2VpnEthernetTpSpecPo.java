...
/**
 * The class of L2Vpn Ethernet TP Specification.<br/>
 * 
 * @author
 * @version SDNO 0.5 2016-6-3
 */
@MOResType(infoModelName = "wan_l2vpn_ethernettpspec")
public class L2VpnEthernetTpSpecPo extends AbstractEthernetTpSpecPo {
