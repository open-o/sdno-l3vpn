 ...
 */
public enum ProtectType implements ModelEnum {
    NOP("nop"), M_1V1V1("1:1"), M_2V1P1("1+1"), HOT_STANDBY("hot-standby");

    private String alias;

    private ProtectType(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static ProtectType fromName(String name) {
        return EnumUtil.valueOf(ProtectType.class, name);
    }
