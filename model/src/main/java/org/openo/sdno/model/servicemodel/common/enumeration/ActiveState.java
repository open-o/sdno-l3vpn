 ...
 */
public enum ActiveState implements ModelEnum {
    ACTIVE_TRUE("true"), ACTIVE_FALSE("false"), ACTIVE_NOP("nop");

    private String alias;

    private ActiveState(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static ActiveState fromName(String name) {
        return EnumUtil.valueOf(ActiveState.class, name);
    }
