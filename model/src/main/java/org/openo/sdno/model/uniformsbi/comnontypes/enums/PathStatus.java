...
/**
 * The enumeration class of path status.<br>
 *
 * @author
 * @version SDNO 0.5 2016-6-6
 */
public enum PathStatus implements ModelEnum {
    ACTIVE("Active"), INACTIVE("Inactive");

    private String alias;

    private PathStatus(String alias) {
        this.alias = alias;
    }
    ...
    public static PathStatus fromName(String name) {
        return EnumUtil.valueOf(PathStatus.class, name);
    }
}
