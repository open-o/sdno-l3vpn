 ...
 */
public enum PoolApplyPolicy implements ModelEnum {
    INTER_AS("InterAS"), NOP("Nop");

    private String alias;

    private PoolApplyPolicy(String alias) {
        this.alias = alias;
    }
     ...
     */
    @JsonCreator
    public static PoolApplyPolicy fromName(String name) {
        return EnumUtil.valueOf(PoolApplyPolicy.class, name);
    }
